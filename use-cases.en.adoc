...
=== Use case scenario - Developing a national Participant node in Darwinia
...
:figure-caption!:
.Photograph "Please leave nothing but your footprints" (Photo by Vlad Chețan from Pexels: https://www.pexels.com/photo/mining-excavation-on-a-mountain-2892618/, licensed under CC-0) 
...
:figure-caption!:
.Photograph "Mining excavation on a mountain" (image via https://www.peakpx.com, licensed under CC-0)
